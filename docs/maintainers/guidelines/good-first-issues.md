# 🐣 Good First Issue Maintainer Guidelines

This guide explains what qualifies as a “Good First Issue”, how to suggest new issues and how to review good first issues.
...
All candidates for good first issues can be found under the `good first issue candidate` label.
